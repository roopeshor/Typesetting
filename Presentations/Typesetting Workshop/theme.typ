  ...
  let body = {
    ...
    grid(
      ...
      block(width: 100%, height: 100%, fill: self.colors.primary)[
        #image("assets/books.webp", width: 6cm)
        #image("assets/spec.webp", width: 6cm)
        #image("assets/letter.webp", width: 6cm)
        #image("assets/report.webp", width: 6cm)
        #place(top + left)[
          #rect(width: 100%, height: 100%, fill: self.colors.primary.transparentize(40%))
        ]
      ],
      [
        #v(50pt)
...
#let my-theme(
  ...
  show: touying-slides.with(
    ...
    config-colors(
      primary: rgb("#3ea5b5"),
      secondary: rgb("#3ea5b5").darken(10%),
