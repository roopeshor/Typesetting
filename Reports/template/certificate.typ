...
#place(center + horizon)[
  ...
  #par(justify: true, leading: 1em)[
    #text(
      size: fontsizes.body,
			style: "italic"
    )[Certified that the seminar report entitled *“Seminar Title”* is a bonafide work of #h(2pt) *Author* #h(2pt) towards the partial fulfillment for the award of the degree of B.Tech in Electronics and Communication of Cochin University of Science and Technology, Kochi-682022.]
  ]
