...
#let ckt-r2mdc = [#circuit(length: 2em, {
  ...
  wire.stub("s2p-port-din", "west", name: [*din*], length: .5)
  wire.stub("s2p-port-in_valid", "west", name: [*in_valid*], length: .5)
  ...
  wire.stub("r2mdc2-port-out_valid", "east", name: [*out valid*], length: .5)
	...
	dwire("clkb-port-p", "s2p-port-clk")
	dwire("clkb-port-p", "r2mdc1-port-clk")
	dwire("clkb-port-p", "r2mdc2-port-clk")
	
	dwire("rstb-port-p", "s2p-port-rst", dy: -2)
	dwire("rstb-port-p", "r2mdc1-port-rst", dy: -2)
	dwire("rstb-port-p", "r2mdc2-port-rst", dy: -2)
  
	vwire("w1", "s2p-port-out_valid", "r2mdc1-port-in_valid")
  vwire("w1", "s2p-port-undelayed", "r2mdc1-port-in1")
  vwire("w1", "s2p-port-delayed", "r2mdc1-port-in0")
  vwire("w1", "s2p-port-out_cnt", "r2mdc1-port-in_cnt")
